<template>
  <div id="user-table">
    ...
    >
      ...
      <el-table-column prop="User_Account" label="账号" width="100">
      </el-table-column>
      ...
      <el-table-column label="操作" width="150">
        ...
        <template slot-scope="scope">
          ...
          <el-tooltip v-if="activename == 'preexamine_user'" class="item" effect="dark" content="审核不通过" placement="top">
            <el-button
              size="mini"
              type="warning"
              circle
          ...
          <el-tooltip v-if="activename == 'fallen_user'" class="item" effect="dark" content="注销" placement="top">
            <el-button
              size="mini"
              type="danger"
